<template>
    <div>
        <div class="modal" data-bs-backdrop="static" tabindex="-1" id="modal-editar-usuario">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" @click.prevent="atualizarUsuario">Salvar</button>
...
export default {
    ...
    mounted() {},
    methods: {
        getUsuarioData: await function (usuario) {
            console.log(usuario)
            this.form = usuario;
            delete this.form.categoria_habilitacao;
            this.form.categoria_habilitacao = usuario.categoria_habilitacao.length !== 0 ? usuario.categoria_habilitacao[0].id : '';
        },
        ...
        deletarUsuario: function (userId) {
            axios.delete('http://localhost:8008/usuarios/' + userId)
                .then(async response => {
                    await this.showMessage(response.data.message);
